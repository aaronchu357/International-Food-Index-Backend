...
# NationalDish.create(name:"Chicken Korma" , description:"Korma is a dish originated in the Indian subcontinent,[1] consisting of meat or vegetables braised with yogurt (dahi) or cream, water or stock, and spices to produce a thick sauce or glaze." , image:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Chicken_Korma.JPG/250px-Chicken_Korma.JPG", location_id: 19 )
...
# NationalDish.create(name:"Gallo Pinto" , description:"Gallo pinto or gallopinto[1] is a traditional dish from Nicaragua. Consisting of rice and beans as a base; Gallo pinto has a long history and is important to various Latin American cultures. The beans in gallo pinto are quickly cooked until the juice is almost consumed, then combined with readied rice, and other ingredients such as cooked bell peppers, chopped onions, and garlic." , image:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/CRI_07_2018_0120.jpg/440px-CRI_07_2018_0120.jpg", location_id: 48 )
...
# NationalDish.create(name:"Crêpe" , description:"A crêpe or crepe (/kreɪp/ (About this soundlisten)[1] or /krɛp/, French: [kʁɛp] (About this soundlisten), Quebec French: [kʁaɪ̯p] (About this soundlisten)) is a type of very thin pancake. Crêpes are usually of two types: sweet crêpes (crêpes sucrées) and savoury galettes (crêpes salées). Crêpes are served with a variety of fillings, from the simplest with only sugar to flambéed crêpes Suzette or elaborate savoury galettes. While crêpes are often associated with Brittany, a region in the northwest of France, their consumption is widespread in France, Belgium, Canada, and many parts of Europe, North Africa, Lebanon, and the Southern Cone of South America." , image:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Crepes_dsc07085.jpg/500px-Crepes_dsc07085.jpg", location_id: 72 )
...
# NationalDish.create(name:"Bacon and Egg Pie", description:"The bacon and egg pie is a savoury pie consisting of a crust containing bacon, egg and sometimes onion, peas, tomato and cheese. Bacon and egg pie may be served with ketchup,[1] and some versions have a rising agent such as baking powder mixed into the egg to make a fluffier filling.The pie is often constructed with a shortcrust or other mechanically stable base crust. The crust is usually topped with a pastry lid,[2] but is sometimes left open.", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Bacon%26egg_pie.jpg/220px-Bacon%26egg_pie.jpg", location_id: 168 )
